...
def viewPDFInvoice(request, slug):
    ...
    #Get Client Settings
    p_settings = Settings.objects.get(clientName='myservices')
...
def viewDocumentInvoice(request, slug):
    ...
    config = pdfkit.configuration(wkhtmltopdf='C:/Users/EXOZENIOT1/Downloads/wkhtmltox/wkhtmltox/bin/wkhtmltopdf.exe')
...
def companySettings(request):
    company = Settings.objects.get(clientName='myservices')
